...
import com.ewyboy.oretweaker.tweaking.ReconstructedFeature;
...
public class OreTweaker {
    ...
    private static void isFirstTimeSetup() {
        if (!Files.exists(DirectoryHandler.ORE_TWEAKER_PATH)) {
            ModLogger.info("Ore Tweaker detected first time setup!");
            initSetup = true;
        }
    }
    ...
    private void loadComplete(final FMLLoadCompleteEvent event) {
        ...
        ReconstructedFeature.reconstructFeatureFromJSON();
    }
