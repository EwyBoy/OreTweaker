...
public class OreTweakerFeature extends Feature<OreTweakerFeatureConfig> {
    ...
    public OreTweakerFeature(Codec<OreTweakerFeatureConfig> codec) {
        super(codec);
        setRegistryName("ore_tweaker_ore");
    }
                                ...
                                for (int k2 = i1; k2 <= l1; ++k2) {
                                    ...
                                    if (d8 * d8 + d9 * d9 + d10 * d10 < 1.0D) {
                                        ...
                                        if (!bitset.get(l2)) {
                                            ...
                                            if (featureConfig.target.test(world.getBlockState(blockpos$mutable), random)) {
                                                world.setBlock(blockpos$mutable, featureConfig.state, 2);
                                                ++i;
                                            }
                                        }
                                    }
